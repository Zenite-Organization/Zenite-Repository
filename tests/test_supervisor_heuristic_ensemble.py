...
class TestSupervisorHeuristicEnsemble(unittest.TestCase):
    def test_combine_heuristic_estimations_llm_path(self):
        estimations = [
            {"source": "heuristic_1", "estimated_hours": 5, "confidence": 0.5, "justification": "a"},
            {"source": "heuristic_2", "estimated_hours": 7, "confidence": 0.7, "justification": "b"},
            {"source": "heuristic_3", "estimated_hours": 9, "confidence": 0.9, "justification": "c"},
        ]
        llm = _FakeLLM('{"estimated_hours": 8, "confidence": 0.81, "justification": "Sintese LLM."}')
    ...
    def test_combine_heuristic_estimations_fallback_median(self):
        estimations = [
            {"source": "heuristic_1", "estimated_hours": 2, "confidence": 0.6, "justification": "a"},
            {"source": "heuristic_2", "estimated_hours": 8, "confidence": 0.7, "justification": "b"},
    ...
    def test_confidence_penalized_on_high_spread(self):
        narrow = [
            {"source": "heuristic_1", "estimated_hours": 7, "confidence": 0.8, "justification": "a"},
            {"source": "heuristic_2", "estimated_hours": 8, "confidence": 0.8, "justification": "b"},
            {"source": "heuristic_3", "estimated_hours": 9, "confidence": 0.8, "justification": "c"},
        ]
        wide = [
            {"source": "heuristic_1", "estimated_hours": 2, "confidence": 0.8, "justification": "a"},
            {"source": "heuristic_2", "estimated_hours": 8, "confidence": 0.8, "justification": "b"},
            {"source": "heuristic_3", "estimated_hours": 20, "confidence": 0.8, "justification": "c"},
        ]
